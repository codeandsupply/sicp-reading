...
;; then the nth repeated application of f is the function x->x + n. If
;; f is the operation of squaring a number, then the nth repeated
;; application of f is the function that raises its argument to the 2
...
;; computes the nth repeated application of f. Your procedure should
