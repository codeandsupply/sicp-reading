...
;; (define (p) (write-string "hello"))  ;;; NOTE
(define (p) (p))
...
;;;;;; WRONG --
;; - In a normal order the program will hang
;;   - Because all of the expressions are expanded, and (p) is recursive
;; - In an applicative order program, it will return 0
;;   - Because the predicate evaluates to true
